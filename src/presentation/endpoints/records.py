...
from src.presentation.schemes.record_schemes import UncompleteRecord
...
@record_router.get("/records", tags=AUTHENTICATED, response_model_exclude_none=True)
async def record_list(user: current_user, service: Annotated[RecordService, Depends()]):
